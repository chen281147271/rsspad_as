...
-keep public class * extends com.rss.pad.adapter
##########JS接口类不混淆，否则执行不了
...
-keep @com.rss.pad.utils.KeepNotProguard class * {*;}
-keep class * {
    @com.rss.pad.utils.KeepNotProguard <fields>;
}
-keepclassmembers class * {
    @com.rss.pad.utils.KeepNotProguard <methods>;
}
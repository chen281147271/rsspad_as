...
import com.rss.pad.core.webview.AgentWebActivity;
...
import static com.rss.pad.core.webview.AgentWebFragment.KEY_URL;
...
public final class Utils {
    ...
    public static void sendBroadcast(Context mContext ,String action,String name,String value,String name2,int value2){
    ...
    public static void sendBroadcast(Context mContext ,String action,String name,boolean value,String name2,int value2){
        Intent intent = new Intent();
        intent.setAction(action);
        intent.putExtra(name,value);
        intent.putExtra(name2,value2);
